...
import edu.matc.copcoderest.persistence.PoliceScannerCodeDao;
...
public class CodeToStringXMLPoliceScannerCode {
    ...
    public Response convertCodeToString(@PathParam("param") String code) {
        ...
        List<PoliceScannerCode> copCodesList = policeScannerCodeDao.getAll();

        for (PoliceScannerCode copCode : copCodesList) {
            copCodesMap.put(copCode.getScannerCode(), copCode.getScannerString());
        }
